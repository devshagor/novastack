                    ...
                    <div className="col-md-6 col-lg-4">
                        <div className="testimonial-item">
                            <div className="testimonial-content">
                                ...
                                <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using iorem Ipsum is that end.</p>
                            </div>
                            <div className="testimonial-info">
                                <h3 className="author-name">John Doe</h3>
                                <p className="author-position">CEO, NovaStack</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-md-6 col-lg-4">
